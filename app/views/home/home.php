    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Stay updated with the latest NBA games, stats, and news. Your personalized basketball experience awaits.</p>
        ...
        <div class="container">
            ...
            <section class="live-games">
                ...
                <div class="games-scroll">
                    ...
                    <div class="game-card">
                        ...
                        <p class="game-info">Today, 7:30 PM ET</p>
                        <button class="watch-button">Set Reminder</button>
                    </div>
                    ...
                    <div class="game-card">
                        ...
                        <p class="game-info">Today, 8:00 PM ET</p>
                        <button class="watch-button">Set Reminder</button>
                    </div>
                    ...
                    <div class="game-card">
                        ...
                        <p class="game-info">Tomorrow, 9:00 PM ET</p>
                        <button class="watch-button">Set Reminder</button>
                    </div>
                </div>
            </section>
            ...
            <section class="stats-section">
                ...
                <div class="stats-tabs">
                    <button class="stats-tab active">Points</button>
                    <button class="stats-tab">Rebounds</button>
                    <button class="stats-tab">Assists</button>
                    <button class="stats-tab">Steals</button>
                    <button class="stats-tab">Blocks</button>
                </div>
                <div class="stats-grid">
                    <div class="player-card">
                        ...
                        <div class="player-info">
                            ...
                            <div>
                                <span class="player-stat">35.3</span>
                    ...
                    <div class="player-card">
                        ...
                        <div class="player-info">
                            ...
                            <div>
                                <span class="player-stat">33.8</span>
                                <span class="player-stat-label">PPG</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="player-card">
                        ...
                        <div class="player-info">
                            ...
                            <div>
                                <span class="player-stat">30.9</span>
                                <span class="player-stat-label">PPG</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="player-card">
                        ...
                        <div class="player-info">
                            ...
                            <div>
                                <span class="player-stat">30.4</span>
                                <span class="player-stat-label">PPG</span>
                            </div>
                        </div>
                    </div>
